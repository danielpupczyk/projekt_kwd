...
class Project(object):
    ...
    def classifier(self):
        ...
        while True:
            ...
            print("6.Znajdź najlepsze wartosci parametrow")
            ...
            if option>'0' and option <= '5':
                ...
                print("Precision_score dla danych trenujących: {0:0.3f}".format(p_score))
                ...
                print("Precision_score dla danych testujących: {0:0.3f}".format(p_score))                                                                                                                        
